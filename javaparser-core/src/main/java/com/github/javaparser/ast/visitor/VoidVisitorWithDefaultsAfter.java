...
/**
 * Adapted from {@link com.github.javaparser.ast.visitor.VoidVisitorWithDefaultsAfter}. <br>
 * <br>
 * A visitor that returns nothing, and has default methods that are used when a specific visit method is not overridden.
 */
public abstract class VoidVisitorWithDefaultsAfter<A> extends VoidVisitorAdapter<A> {
   /**
    ...
    * This will be called by every node visit method that is not overridden.
    */
   public void defaultActionAfter(Node n, A arg) {
   }

   /**
    * This will be called by the NodeList visit method when it is not overridden.
    */
   public void defaultAction(@SuppressWarnings("rawtypes") NodeList n, A arg) {
   }

   /**
    * This will be called by the NodeList visit method when it is not overridden.
    */
   public void defaultActionAfter(@SuppressWarnings("rawtypes") NodeList n, A arg) {
   }
   ...
   @Override
   public void visit(@SuppressWarnings("rawtypes") NodeList n, A arg) {
      defaultAction(n, arg);
      super.visit(n, arg);
   }
