 ...
 */
public class PrettyPrintVisitorOrphanComments implements VoidVisitor<Void> {
    protected final PrettyPrinterConfiguration configuration;
    protected final SourcePrinter printer;

    public PrettyPrintVisitorOrphanComments(PrettyPrinterConfiguration prettyPrinterConfiguration) {
